...
const merge_null_val_objs_1 = require("../extract/helpers/merge-null-val-objs");
describe("mergeNullValObjs", () => {
    it("should merge the objects with null values", async () => {
        ...
        const result = (0, merge_null_val_objs_1.mergeNullValObjs)(objArray);
...
//# sourceMappingURL=merge-null-val-objs.test.js.map