...
describe("HTML Transformer", () => {
    describe("extractLinks", () => {
        it("should return empty array for null or undefined input", async () => {
            expect(await (0, html_transformer_1.extractLinks)(null)).toEqual([]);
            expect(await (0, html_transformer_1.extractLinks)(undefined)).toEqual([]);
        });
    ...
    describe("extractMetadata", () => {
        it("should return empty array for null or undefined input", async () => {
            expect(await (0, html_transformer_1.extractMetadata)(null)).toEqual([]);
            expect(await (0, html_transformer_1.extractMetadata)(undefined)).toEqual([]);
        });
      ...
      `;
            const metadata = await (0, html_transformer_1.extractMetadata)(html);
    ...
    describe("transformHtml", () => {
        it("should transform HTML content according to options", async () => {
            ...
            const result = await (0, html_transformer_1.transformHtml)(options);
...
//# sourceMappingURL=html-transformer.test.js.map