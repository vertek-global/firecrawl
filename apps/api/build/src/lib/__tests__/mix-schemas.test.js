...
const mix_schema_objs_1 = require("../extract/helpers/mix-schema-objs");
...
describe("mixSchemaObjects function", () => {
    it("should mix kyb schema (id: 1)", async () => {
        ...
        const finalResult = await (0, mix_schema_objs_1.mixSchemaObjects)(originalSchema, singleAnswerResult, multiEntityResult);
    ...
    it("should handle empty objects correctly (id: 30)", async () => {
        ...
        const multiEntityResult = {};
        const finalResult = await (0, mix_schema_objs_1.mixSchemaObjects)(originalSchema, singleAnswerResult, {});
        expect(finalResult).toEqual(singleAnswerResult);
    });
...
//# sourceMappingURL=mix-schemas.test.js.map