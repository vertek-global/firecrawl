...
const deduplicate_objs_array_1 = require("../extract/helpers/deduplicate-objs-array");
describe("deduplicateObjectsArray", () => {
    it("should deduplicate the array", async () => {
        ...
        const result = await (0, deduplicate_objs_array_1.deduplicateObjectsArray)(objArray);
...
//# sourceMappingURL=deduplicate-obs-array.test.js.map