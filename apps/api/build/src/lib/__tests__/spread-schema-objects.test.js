...
const spread_schemas_1 = require("../extract/helpers/spread-schemas");
describe("spreadSchemas", () => {
    it("should spread kyb schema (id: 1)", async () => {
        ...
        const { singleAnswerSchema, multiEntitySchema } = await (0, spread_schemas_1.spreadSchemas)(schema, keys);
...
//# sourceMappingURL=spread-schema-objects.test.js.map