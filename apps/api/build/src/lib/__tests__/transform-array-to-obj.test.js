...
const transform_array_to_obj_1 = require("../extract/helpers/transform-array-to-obj");
...
describe("transformArrayToObject function", () => {
    it("shoud transform array to object (id: 26)", async () => {
        ...
        expect(await (0, transform_array_to_obj_1.transformArrayToObject)(originalSchema, results)).toEqual(multiEntityResult);
    });
    ...
    it("more complex schema", async () => {
        ...
        console.log(await (0, transform_array_to_obj_1.transformArrayToObject)(originalSchema, results));
        expect(await (0, transform_array_to_obj_1.transformArrayToObject)(originalSchema, results)).toEqual(multiEntityResult);
    });
    it("even more complex schema", async () => {
        ...
        console.log(multiEntityResult, await (0, transform_array_to_obj_1.transformArrayToObject)(moreComplexSchema, results));
        expect(await (0, transform_array_to_obj_1.transformArrayToObject)(moreComplexSchema, results)).toEqual(multiEntityResult);
    });
    it("should transform array to object (id: 7)", async () => {
        ...
        expect(await (0, transform_array_to_obj_1.transformArrayToObject)(originalSchema, results)).toEqual(results[0]);
    });
});
//# sourceMappingURL=transform-array-to-obj.test.js.map