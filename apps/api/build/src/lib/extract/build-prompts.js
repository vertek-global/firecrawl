...
exports.buildRefrasedPrompt = buildRefrasedPrompt;
exports.buildPreRerankPrompt = buildPreRerankPrompt;
exports.buildRerankerSystemPrompt = buildRerankerSystemPrompt;
exports.buildRerankerUserPrompt = buildRerankerUserPrompt;
exports.buildAnalyzeSchemaPrompt = buildAnalyzeSchemaPrompt;
exports.buildAnalyzeSchemaUserPrompt = buildAnalyzeSchemaUserPrompt;
exports.buildShouldExtractSystemPrompt = buildShouldExtractSystemPrompt;
exports.buildShouldExtractUserPrompt = buildShouldExtractUserPrompt;
exports.buildBatchExtractSystemPrompt = buildBatchExtractSystemPrompt;
exports.buildBatchExtractPrompt = buildBatchExtractPrompt;
exports.buildRephraseToSerpPrompt = buildRephraseToSerpPrompt;
function buildRefrasedPrompt(prompt, url) {
...
function buildPreRerankPrompt(prompt, schema, url) {
...
function buildRerankerSystemPrompt() {
...
function buildRerankerUserPrompt(searchQuery) {
...
function buildAnalyzeSchemaPrompt() {
...
function buildAnalyzeSchemaUserPrompt(schemaString, prompt, urls) {
...
// Should Extract
function buildShouldExtractSystemPrompt() {
...
function buildShouldExtractUserPrompt(prompt, schema) {
...
// Batch extract
function buildBatchExtractSystemPrompt(systemPrompt, multiEntitySchema, links) {
...
function buildBatchExtractPrompt(prompt) {
    return `Today is: ${new Date().toISOString()}\n${prompt}`;
}
function buildRephraseToSerpPrompt(prompt) {
...
//# sourceMappingURL=build-prompts.js.map