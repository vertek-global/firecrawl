...
describe("SourceTracker", () => {
    let sourceTracker;
    beforeEach(() => {
        sourceTracker = new source_tracker_1.SourceTracker();
    });
    describe("transformResults", () => {
        ...
        it("should match original transformArrayToObject behavior", () => {
            ...
            const originalResult1 = (0, transform_array_to_obj_1.transformArrayToObject)(schema1, extractionResults1.map(r => r.extract));
            ...
            const originalResult2 = (0, transform_array_to_obj_1.transformArrayToObject)(schema2, extractionResults2.map(r => r.extract));
            const newResult2 = sourceTracker.transformResults(extractionResults2, schema2);
            expect(newResult2).toEqual(originalResult2);
            // Test case 3: Empty arrays
            const emptyResults = [];
            const originalResult3 = (0, transform_array_to_obj_1.transformArrayToObject)(schema1, emptyResults);
            ...
            const originalResult4 = (0, transform_array_to_obj_1.transformArrayToObject)(schema4, extractionResults4.map(r => r.extract));
    ...
    describe("mapSourcesToFinalItems", () => {
        ...
        it("should handle non-array properties", () => {
            const sources = sourceTracker.mapSourcesToFinalItems({ nonArray: "value" }, ["nonArray"]);
            expect(sources).toEqual({});
        });
    });
...
//# sourceMappingURL=source-tracker.test.js.map