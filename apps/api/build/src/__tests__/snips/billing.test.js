...
const sleep = (ms) => new Promise(x => setTimeout(() => x(true), ms));
...
describe("Billing tests", () => {
    if (process.env.TEST_SUITE_SELF_HOSTED) {
        ...
        it.concurrent("bills scrape correctly", async () => {
            const identity = await (0, lib_1.idmux)({
                name: "billing/bills scrape correctly",
                credits: 100,
            });
            const rc1 = (await (0, lib_1.creditUsage)(identity)).remaining_credits;
            ...
            const rc2 = (await (0, lib_1.creditUsage)(identity)).remaining_credits;
        ...
        it.concurrent("bills map correctly", async () => {
            ...
            const rc1 = (await (0, lib_1.creditUsage)(identity)).remaining_credits;
            await (0, lib_1.map)({ url: "https://firecrawl.dev" }, identity);
            await sleepForBatchBilling();
            const rc2 = (await (0, lib_1.creditUsage)(identity)).remaining_credits;
        ...
        it.concurrent("bills search correctly", async () => {
            ...
            const rc1 = (await (0, lib_1.creditUsage)(identity)).remaining_credits;
            const results = await (0, lib_1.search)({
                query: "firecrawl"
            }, identity);
            await sleepForBatchBilling();
            const rc2 = (await (0, lib_1.creditUsage)(identity)).remaining_credits;
        ...
        it.concurrent("bills extract correctly", async () => {
            ...
            const rc1 = (await (0, lib_1.tokenUsage)(identity)).remaining_tokens;
            const extractResult = await (0, lib_1.extract)({
            ...
            await sleepForBatchBilling();
            const rc2 = (await (0, lib_1.tokenUsage)(identity)).remaining_tokens;
