...
describe("E2E Tests for v1 API Routes", () => {
    it.concurrent("should return a successful response for a scrape with 403 page", async () => {
        const response = await (0, supertest_1.default)(FIRECRAWL_API_URL)
            .post("/v1/scrape")
    ...
    it.concurrent("should handle 'formats:markdown (default)' parameter correctly", async () => {
        const scrapeRequest = {
    ...
    it.concurrent("should handle 'formats:html' parameter correctly", async () => {
        const scrapeRequest = {
            url: E2E_TEST_SERVER_URL,
            formats: ["html"],
        };
    ...
    it.concurrent("should handle 'rawHtml' in 'formats' parameter correctly", async () => {
        const scrapeRequest = {
            url: E2E_TEST_SERVER_URL,
            formats: ["rawHtml"],
        };
    ...
    it.concurrent("should handle 'includeTags' parameter correctly", async () => {
        const scrapeRequest = {
            url: E2E_TEST_SERVER_URL,
    ...
    it.concurrent("should handle 'excludeTags' parameter correctly", async () => {
        const scrapeRequest = {
            url: E2E_TEST_SERVER_URL,
    ...
    it.concurrent("should handle 'onlyMainContent' parameter correctly", async () => {
        const scrapeRequest = {
            url: E2E_TEST_SERVER_URL,
    ...
    it.concurrent("should handle 'timeout' parameter correctly", async () => {
        const scrapeRequest = {
            url: E2E_TEST_SERVER_URL,
            timeout: 500,
        };
    ...
    it.concurrent("should handle 'mobile' parameter correctly", async () => {
        const scrapeRequest = {
            url: E2E_TEST_SERVER_URL,
            mobile: true,
        };
    ...
    it.concurrent("should handle 'parsePDF' parameter correctly", async () => {
        const response = await (0, supertest_1.default)(FIRECRAWL_API_URL)
            .post("/v1/scrape")
            .set("Authorization", `Bearer ${process.env.TEST_API_KEY}`)
            .set("Content-Type", "application/json")
        ...
        const responseNoParsePDF = await (0, supertest_1.default)(FIRECRAWL_API_URL)
            .post("/v1/scrape")
            .set("Authorization", `Bearer ${process.env.TEST_API_KEY}`)
            .set("Content-Type", "application/json")
            .send({
    ...
    //   },
    // 30000);
    it.concurrent("should handle 'skipTlsVerification' parameter correctly", async () => {
        const scrapeRequest = {
        ...
        const responseWithSkipTlsVerification = await (0, supertest_1.default)(FIRECRAWL_API_URL)
            .post("/v1/scrape")
            .set("Authorization", `Bearer ${process.env.TEST_API_KEY}`)
            .set("Content-Type", "application/json")
    ...
    it.concurrent("should handle 'removeBase64Images' parameter correctly", async () => {
        const scrapeRequest = {
            url: E2E_TEST_SERVER_URL,
    ...
    it.concurrent("should handle 'action wait' parameter correctly", async () => {
        const scrapeRequest = {
            url: E2E_TEST_SERVER_URL,
            actions: [
                {
    ...
    // screenshot
    it.concurrent("should handle 'action screenshot' parameter correctly", async () => {
        const scrapeRequest = {
            url: E2E_TEST_SERVER_URL,
            actions: [
                {
    ...
    it.concurrent("should handle 'action screenshot@fullPage' parameter correctly", async () => {
        const scrapeRequest = {
            url: E2E_TEST_SERVER_URL,
            actions: [
                {
    ...
    it.concurrent("should handle 'action click' parameter correctly", async () => {
        const scrapeRequest = {
            url: E2E_TEST_SERVER_URL,
            actions: [
                {
    ...
    it.concurrent("should handle 'action write' parameter correctly", async () => {
        const scrapeRequest = {
            url: E2E_TEST_SERVER_URL,
            formats: ["html"],
            actions: [
    ...
    // TODO: fix this test (need to fix fire-engine first)
    it.concurrent("should handle 'action pressKey' parameter correctly", async () => {
        const scrapeRequest = {
            url: E2E_TEST_SERVER_URL,
            formats: ["markdown"],
            actions: [
    ...
    // TODO: fix this test (need to fix fire-engine first)
    it.concurrent("should handle 'action scroll' parameter correctly", async () => {
        const scrapeRequest = {
            url: E2E_TEST_SERVER_URL,
            formats: ["markdown"],
            actions: [
